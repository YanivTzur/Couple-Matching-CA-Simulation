...
public class CAView extends JFrame implements ActionListener, ItemListener
{
	...
	private Image _transparentMaleFemaleCoupleIconImage; // Used as the icon at the top left side
														 // of the window.
	...
	public CAView()
	{
		...
		setIconImage(_transparentMaleFemaleCoupleIconImage);
	 ...
	 * @param lookAndFeelClassName The class name of the LookAndFeel class corresponding to the
	 ...
	 * @param controller the controller to set as the view's new controller.
	 */
	...
	private void loadImages()
	{
		try
		{
			_transparentFemaleImage = loadImage("transparentFemaleImage.png");
			_transparentMaleImage = loadImage("transparentMaleImage.png");
			_transparentMaleFemaleCoupleImage = loadImage("transparentMaleFemaleCoupleImage.png");
			_transparentMaleFemaleCoupleIconImage = loadImage("transparentMaleFemaleCoupleIconImage.png");
		}
		catch(Exception e)
		{
	...
	{
		BoardView boardView = new BoardView(_transparentFemaleImage, _transparentMaleImage,
											_transparentMaleFemaleCoupleImage);
		return boardView;
	}
	 ...
	 * and returns it.
	 * @return The side panel of the automaton's GUI containing controls and information for the user.
	 */
	 ...
	 * @return The panel containing controls for altering the automaton's rules.
	 */
	private JPanel createRulesPanel()
	{
		...
		labels.addAll(Arrays.asList(new JLabel[] {rulesPanelTitle, alwaysPairLabel, 
												  stationaryPairsLabel, loyalPairsLabel, 
												  memoryEnabledLabel, numOfPartnersRememberedLabel}));
		interactiveControls.addAll(Arrays.asList(new JComponent[] {_alwaysPairCheckbox,
																   _stationaryPairsCheckbox,
																   _loyalPairsCheckBox,
																   _memoryEnabledCheckBox,
																   _numOfPartnersRememberedTextField}));
	 ...
	 * @param allControls all child controls of the interactive panel.
	 * @return a dictionary structure mapping pairs of (x,y) coordinates to their respective controls.
	 */
	 ...
	 * @param rulesPanel contains controls for changing the rules governing the CA.
	 * @param coordinateMapping A mapping between the coordinate of each control and the respective
	 * 							control.
	 */
	 ...
	 * following it.
	 * @param labels Labels containing text to which different fonts can be applied.
	 */
	...
	private JPanel createStatisticsPanel()
	{
		...
		labels = new ArrayList<JLabel>(Arrays.asList(new JLabel[]{
	 ...
	 * @return The panel used to control when the automaton starts and stops updating itself.
	 */
	 ...
	 * layout.
	 * @param innerPanel the panel to surround by a JPanel.
	 * @param layout the layout to set for the outer panel.
	 * @return the surrounding panel with the input panel composed inside it.
	 */
	 ...
	 * @param board A collection of the state of each of the automaton's cells.
	 * @param newGeneration The current generation of the current run of the automaton.
	 * @param averageHappiness The average level of happiness among couples in the automaton.
	 */
	public void updateView(State[][] board, int newGeneration, int averageHappiness)
	{
	 ...
	 * @return Whether to limit the number of generations to run the automaton for.
	 */
	 ...
	 * @return The content of the _numOfGenToRunTextField field if it contains an integer.
	 * 		   If the field contains invalid input (i.e. not an integer) returns a default value.
	 */
	 ...
	 * @return Whether the "Always Pair" rule is enabled.
	 */
	 ...
	 * @return Whether the "Stationary Pairs" rule is active.
	 */
	 ...
	 * @return Whether members of existing couples should separate and form new couples should they
	 * 		   come across more suitable partners.
	 */
	 ...
	 * @return Whether the "Remember Ex's" rule is active.
	 */
	 ...
	 * @return The number of former partners to be remembered by men/women in order to avoid
	 * 		   recreating a couple with them.
	 */
	 ...
	 * @param exceptionString The message of the exception.
	 */
