...
{	
	 ...
	 * index.
	 * @param stateType The type of object (e.g. man/woman/couple) represented by the state
	 * 		  to create.
	 */
	 ...
	 * @param manIndex The relationship index for a man inhabiting the cell with this state.
	 * @param womanIndex The relationship index for a woman inhabiting the cell with this state.
	 * @param combinedIndex The combined relationship index of the man-woman couple.
	 * @param manPastPartnerIndices Hold the state's memory of past relationships with women
	 * 								for when the state represents a man.
	 * @param womanPastPartnerIndices Hold the state's memory of past relationships with men
	 * 								  for when the state represents a woman.
	 * @param manOldestPastPartnerIndex The array index of the oldest remembered past female partner
	 * 									when the state represents a man.
	 * @param womanOldestPastPartnerIndex The array index of the oldest remembered past male partner
	 * 									  when the state represents a woman.
	 */
	 ...
	 * @param womanIndex The relationship index for a woman inhabiting the cell with this state.
	 * @param combinedIndex The combined relationship index of the man-woman couple.
	 * @param createRandomIndex Create a new random index and assign
	 * @param manPastPartnerIndices Hold the state's memory of past relationships with women
	 * 								for when the state represents a man.
	 * @param womanPastPartnerIndices Hold the state's memory of past relationships with men
	 * 								  for when the state represents a woman.
	 ...
	 * @param combinedIndex The combined relationship index of the man-woman couple.
	 * @param createRandomIndex Create a new random index and assign
	 * @param pairedMember Denotes the sex of the member of a couple who will separate from its
	 * 					   partner in the current generation and create a new couple with a new
	 * 					   neighbor partner in the next generation.
	 * @param manPastPartnerIndices Hold the state's memory of past relationships with women
	 * 								for when the state represents a man.
	 * @param womanPastPartnerIndices Hold the state's memory of past relationships with men
	 * 								  for when the state represents a woman.
	 ...
	 * @param stateType The type of the state for which to return the opposite sex.
	 * @return If the input state type represents a sex, returns the opposite sex.
	 * 		   Otherwise, returns the same state type.
	 */
	 ...
	 * @param stateType The type for which to return the corresponding array index.
	 * @return The array index of the oldest saved past partner's relationship index for the sex
	 ...
	 * @param stateType Whether the input state is a man, a woman or something else 
	 * 					that is irrelevant.
	 * @param pastPartnerIndices Contains past partners' relationship indices in order to help
	 * 							 avoid pairing with worse partners in the future.
	 */
	 ...
	 * @param stateType The type of array to save the value in (e.g. man/woman memory).
	 * @param oldestPastPartnerIndex The index of the oldest saved past partner's relationship index
	 * 							     in the appropriate "memory" array.
	 */
	 ...
	 * @param neighborStateType The state of a neighbor cell.
	 * @return The relationship index corresponding to a person of the sex opposite to that
	 * 		   represented by the input state of a neighboring cell.
	 */
	 ...
	 * @return The sex of the member of a couple represented by the state who has been paired with
	 * 		   a different partner in the next generation.
	 */
	 ...
	 * @param stateType Expected to be a single person state type representing the sex of
	 * 					the partner in a current couple represented by the current state
	 * 					who wants to separate and form a couple with another preferred single
	 * 					neighbor.
	 */
	 ...
	 * state.
	 * @param stateType The type of object for which to retrieve the corresponding index.
	 * @return The index corresponding to the input state type.
	 */
	 ...
	 * @return The type of object represented by the state.
	 */
	 ...
	 * @param stateType The type of object the state is supposed to represent.
	 * @param index The value of the index relevant to the type of object the object is supposed
	 * 				to represent.
	 */
	 ...
	 * @param stateType The new value to set as the state's type.
	 */
	 ...
	 * in the state.
	 * @param manIndex The new value to set for the man's relationship index contained in the state.
	 */
	 ...
	 * in the state.
	 * @param womanIndex The new value to set for the woman's relationship index contained in 
	 * 					 the state.
	 */
	 ...
	 * in the state.
	 * @param combinedRelationshipIndex The new value to set for the combined relationship index 
	 ...
	 * @param state The state of a cell in the 2-D automaton's space.
	 * @return Whether the input state represents an "empty" state, representing no defined object
	 * 		   (e.g. man, woman, couple).
	 */
